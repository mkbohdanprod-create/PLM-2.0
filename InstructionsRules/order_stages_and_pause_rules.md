...
| | `PAUSED_MEASUREMENT_SCHEDULING` | **Відправлено на паузу** | Заморожено на етапі планування заміру. Причина в коментарі. |
...
| | `PAUSED_ENGINEERING` | **Відправлено на паузу** | Заморожено на етапі конструювання. Причина в коментарі. |
...
| | `PAUSED_PRODUCTION` | **Відправлено на паузу** | Заморожено на етапі виробництва. Причина в коментарі. |
| **Планування монтажу** | `INSTALLATION_SCHEDULING` | **Очікує планування монтажу (Нове)** | Диспетчер формує пули монтажників. |
| | `PAUSED_INSTALLATION_SCHED` | **Відправлено на паузу** | Заморожено на етапі планування. Причина в коментарі. |
...
| | `PAUSED_DELIVERY` | **Відправлено на паузу** | Заморожено на етапі доставки. Причина в коментарі. |
