-- Fix pause order to always cancel active tasks
...
AS $function$
BEGIN
  -- Always cancel existing active tasks when pausing
  ...
  -- If a pre-scheduled date is provided, create a new one without a measurer
