-- Give 4 hours for rescheduling when order is dropped
...
BEGIN
  ...
  SET status = v_target_status,
      ...
      planned_call_date = CASE 
        ...
        WHEN v_target_status = 'MEASUREMENT_SCHEDULING' AND v_current_status != 'MEASUREMENT_SCHEDULING' THEN now() + interval '4 hours'
