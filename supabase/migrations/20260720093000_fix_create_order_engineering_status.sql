-- Fix create_order function: replace ENGINEERING_DESIGN with ENGINEERING_QUEUE
...
BEGIN
  ...
  IF p_order_type = 'BY_DRAWING' THEN
    -- Changed from ENGINEERING_DESIGN to ENGINEERING_QUEUE due to Wave 6 refactoring
    v_initial_status := 'ENGINEERING_QUEUE';
  ELSE
