...
async function fix() {
  ...
  // drop any 11-arg signature that might have snuck back in due to patching
  ...
  console.log("Dropped 11-arg signature again");
  ...
  let res = await client.query(`
    SELECT * FROM create_order('E2E-TEST-3', $1, 'FULL_CYCLE', 'Test Flow 3', '380991234569', 'Kyiv', 'St', '1', 'PVC', 10, true, null, null, null, null, null, null);
  `, [valid_branch]);
